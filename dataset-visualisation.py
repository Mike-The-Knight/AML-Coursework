...
def find_and_display_examples(image_dir, annotation_dir, class_names):
    ...
    for filename in os.listdir(annotation_dir):
        if filename.endswith('.txt'):  # Assuming annotation files are in .txt format
...
find_and_display_examples(image_directory, annotation_directory, class_names)
